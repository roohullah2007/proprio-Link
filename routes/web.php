...
Route::middleware(['auth', 'admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::prefix('pricing')->name('pricing.')->group(function () {
        ...
        // Cities CRUD
        Route::post('/cities', [PricingController::class, 'storeCity'])->name('cities.store');
        Route::put('/cities/{city}', [PricingController::class, 'updateCity'])->name('cities.update');
        Route::delete('/cities/{city}', [PricingController::class, 'destroyCity'])->name('cities.destroy');
        Route::post('/cities/add-defaults', [PricingController::class, 'addDefaultCities'])->name('cities.add-defaults');

        // Tiers CRUD
        Route::put('/tiers/{tier}', [PricingController::class, 'updateTier'])->name('tiers.update');

        // Settings
        Route::put('/settings', [PricingController::class, 'updateSettings'])->name('settings.update');

        // Utilities
        Route::post('/calculate', [PricingController::class, 'calculatePrice'])->name('calculate');
        Route::get('/matrix', [PricingController::class, 'getMatrix'])->name('matrix');
    });
