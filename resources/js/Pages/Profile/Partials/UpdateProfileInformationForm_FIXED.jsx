...
export default function UpdateProfileInformation({
    ...
    const submit = (e) => {
        ...
        // Add PATCH method override for Laravel
        formData.append('_method', 'PATCH');
        
        // Submit using post with FormData
        patch(route('profile.update'), {
            data: formData,
            onSuccess: () => {
                // Profile updated successfully - clear any lingering errors
                clearErrors();
            },
            onError: (errors) => {
    ...
    return (
        <section className={className}>
            <form onSubmit={submit} className="space-y-6">
                ...
                <div>
                    <ProfileImageUpload
                        currentImage={user.profile_image ? (user.profile_image.startsWith('http') ? user.profile_image : `/storage/${user.profile_image}`) : null}
