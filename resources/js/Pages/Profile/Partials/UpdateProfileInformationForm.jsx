...
export default function UpdateProfileInformation({
    ...
    const submit = (e) => {
        ...
        formData.append('numero_siret', data.numero_siret || '');
        
        // Add files if they exist
        if (data.profile_image instanceof File) {
            formData.append('profile_image', data.profile_image);
            console.log('Adding profile image:', data.profile_image.name, data.profile_image.size, 'bytes');
        }
        if (data.licence_professionnelle instanceof File) {
            formData.append('licence_professionnelle', data.licence_professionnelle);
        }
        ...
        console.log('Submitting with FormData:', {
            ...
            hasProfileImage: formData.has('profile_image'),
            hasLicense: formData.has('licence_professionnelle')
        });
        ...
        router.post(route('profile.update'), formData, {
            onSuccess: (page) => {
                ...
                if (page.props.auth?.user) {
                    ...
                    setData({
                        ...
                        numero_siret: updatedUser.numero_siret || '',
                        licence_professionnelle: null,
                        profile_image: null,
                    });
                }
            ...
            onError: (errors) => {
                ...
                console.error('Error breakdown:', {
                    ...
                    fullErrorObject: errors
                });
                
                // Show user-friendly error message
                alert('Profile update failed. Please check the console for details and try again.');
            },
            preserveScroll: true,
            onStart: () => {
            ...
            <form onSubmit={submit} className="space-y-6">
                ...
                <div>
                    <ProfileImageUpload
                        ...
                        onChange={(file) => {
                            console.log('Profile image selected:', file ? file.name : 'null');
