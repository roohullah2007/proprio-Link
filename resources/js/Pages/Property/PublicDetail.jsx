...
export default function PublicDetail({ property, propertyTypes, similarProperties, locale = 'fr', auth = null }) {
    ...
    return (
        <PublicLayout>
                                ...
                                <div className="relative">
                                    {property.images && property.images.length > 0 ? (
                                        <>
                                            ...
                                            {property.images.length > 1 && (
                                                <div className="p-4 md:p-6 bg-[#EBF4FF]">
                                                    <div className="grid grid-cols-4 md:grid-cols-6 gap-2 md:gap-4">
                                                        {property.images.slice(0, 6).map((image, index) => (
                                                            <button
                                                                key={image.id}
                                                                onClick={() => setCurrentImageIndex(index)}
                                                                className={`relative h-16 md:h-20 rounded-lg overflow-hidden transition-all duration-300 hover:scale-105 border-2 ${
                                                        ...
                                                        {property.images.length > 6 && (
                                                            <button
                                                                ...
                                                                className="h-16 md:h-20 bg-[#EAEAEA] rounded-lg flex items-center justify-center hover:bg-[#0F44FC] hover:text-white transition-all duration-300 border-2 border-[#EAEAEA] hover:border-[#0F44FC]"
                                                            >
            ...
            {/* Admin Status Banner */}
            {isAdmin && (
                <div className="fixed top-0 left-0 right-0 bg-gradient-to-r from-blue-600 to-purple-600 text-white px-4 py-2 z-40">
