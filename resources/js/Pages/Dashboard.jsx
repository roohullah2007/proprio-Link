...
export default function Dashboard({ auth, properties = [], stats = {} }) {
    ...
    const statCards = [
        {
            title: __('Published Properties'),
            value: formatNumber(stats.published_properties || 0),
            change: '+12.5%',
            trend: 'up',
            icon: Icons.Home,
            color: 'blue'
        ...
        {
            title: __('Contacts Sold'),
            value: formatNumber(stats.contacts_sold || 0),
            change: '+15.3%',
            trend: 'up',
            icon: Icons.Users,
            color: 'purple'
        ...
        {
            title: __('Property Views'),
            value: formatNumber(stats.property_views || 0),
            change: '+5.7%',
            trend: 'up',
            icon: Icons.Eye,
            color: 'orange'
    ...
    const quickActions = [
        {
            ...
            description: __('Publish a new real estate property'),
            icon: Icons.Plus,
        ...
        },
        {
            ...
            description: __('Manage your existing properties'),
            icon: Icons.Home,
            href: '/properties',
            color: 'green'
        },
        {
            title: __('Analytics'),
            description: __('View detailed performance metrics'),
    ...
    return (
        ...
        >
            <Head title={__("Dashboard") + " - Proprio Link"} />
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                <h2 className="text-2xl font-semibold text-[#000] font-inter mb-2">
                                    {__("Welcome back, :name!", { name: `${user.prenom} ${user.nom}` })}
                                </h2>
                                <p className="text-[#6C6C6C] font-inter">
                                    {__("Manage your properties and track your performance.")}
                                </p>
                            </div>
                            ...
                            <div>
                                {user.est_verifie ? (
                                    ...
                                    <div className="flex justify-center items-center px-[12px] py-[6px] gap-[8px] min-w-max h-[32px] bg-yellow-500 border border-yellow-500 rounded-full flex-none order-0 flex-grow-0 transition-colors hover:bg-yellow-600 focus:outline-none focus:bg-yellow-600">
                                        <svg className="w-4 h-4 text-white flex-none order-0 flex-grow-0" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            {quickActions.map((action, index) => {
                                ...
                                return (
                                    <Link
                                        key={index}
                                        href={action.href}
                                        className="group bg-[#F5F9FA] border border-[#EAEAEA] rounded-xl p-6 hover:bg-white hover:border-[#CEE8DE] transition-all duration-200"
                                    >
